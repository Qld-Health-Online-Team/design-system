...
const meta = {
  ...
  argTypes: {
    displayLastUpdated: {
      description: "Whether 'Last updated' block renders.",
      control: {
        type: "radio",
    ...
    pageType: {
      description: "The type of page this component will be displayed on.",
      control: {
        type: "select",
        labels: {
    ...
    showBackToTop: {
      description: "Whether 'Back to top' block renders.",
