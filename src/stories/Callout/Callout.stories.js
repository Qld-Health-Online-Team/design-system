...
const meta = {
  ...
  argTypes: {
    ...
    calendarIntro: {
      description: "The calendar introduction of the callout.",
      control: "text",
    },
    calendarDate: {
      description: "The calendar date of the callout.",
      control: "text",
    },
    calendarName: {
      description: "The calendar name of the callout.",
      control: "text",
    },
  },
  args: {
