...
const meta = {
 ...
 argTypes: {
  ...
  introShow: {
   description:
    "Whether the intro heading/body block renders.",
  ...
  rowNum: {
   description:
    "Number of rows the component should render, max 10.",
  ...
  col1Width: {
   description:
    "Manual width override for column 1.",
...
export const ParagraphSpacing = {
 args: {
  rowNum: 3, spaceRows: "qld__row-gap-p"
 },
};
