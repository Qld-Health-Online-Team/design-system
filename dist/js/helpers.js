...
Handlebars.registerHelper('listAZ', function(items, url, options) {
    ...
    for(var i = 0; i < letters.length; i++) {
        ...
        html += '<ul class="row qld__a-z_listing__list__item__services">';
        for(var k = 0; k < services[letters[i]].length; k++) {
            html += '<li class="col-lg-4 col-md-6 col-xs-12 qld__a-z_listing__list__item__services__item"><a class="qld__a-z_listing__list__item__services__item__link" href="./?a='+services[letters[i]][k].id+'"><span>'+services[letters[i]][k].name+'</span><i class="fas fa-arrow-right"></i></a></li>';
        }
        html += '</ul>';
    }
