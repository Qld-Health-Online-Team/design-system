...
const breadcrumbsArgs = {
  ...
  lineage: [
    ...
    {
      asset_type_code: "page",
      asset_short_name: "Design system",
      asset_is_site_asset: "2",
    },
    {
      asset_type_code: "page",
      asset_short_name: "Library",
      asset_is_site_asset: "2",
    },
    {
      asset_type_code: "page",
...
export const overflow = {
  ...
  render: (args) => {
    return (
      `<section class="qld__body qld__body--breadcrumb"><div class="container-fluid">` +
      render(args) +
      `</div></section>`
    );
  },
...
export const lightOverflow = {
  ...
  render: (args) => {
    return (
      `<section class="qld__body qld__body--breadcrumb"><div class="container-fluid">` +
      themeWrapper(themes["light"], `${render(args)}`) +
      `</div></section>`
    );
  },
};
...
export const lightAltOverflow = {
  ...
  render: (args) => {
    return (
      `<section class="qld__body qld__body--breadcrumb"><div class="container-fluid">` +
      themeWrapper(themes["light alt"], `${render(args)}`) +
      `</div></section>`
    );
  },
};
...
export const darkOverflow = {
  ...
  render: (args) => {
    return (
      `<section class="qld__body qld__body--breadcrumb"><div class="container-fluid">` +
      themeWrapper(themes["dark"], `${render(args)}`) +
      `</div></section>`
    );
  },
};
...
export const darkAltOverflow = {
  ...
  render: (args) => {
    return (
      `<section class="qld__body qld__body--breadcrumb"><div class="container-fluid">` +
      themeWrapper(themes["dark alt"], `${render(args)}`) +
      `</div></section>`
    );
  },
};
