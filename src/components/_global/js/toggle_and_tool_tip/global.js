  ...
  var toggleToolTips = {
    ...
    doesElementOverlapAnySide: function (content) {
      ...
      return !(
        ...
        contentDimensions.bottom + this.marginFromSide <=
          document.documentElement.clientHeight &&
        contentDimensions.right + this.marginFromSide <=
    ...
    elementCloserToLeft: function (element) {
      ...
      return (
        contentDimensions.left + contentDimensions.width / 2 < screenCenter
      );
    },
    ...
    elementCloserToTop: function (element) {
      ...
      return (
        contentDimensions.top + contentDimensions.height / 2 < screenCenter
      );
    },
    ...
    positionContentBox: function (trigger, toggleToolTip, marginFromTrigger) {
      ...
      const contentMarginFromTrigger =
        marginFromTrigger + carat.offsetWidth / 2;
      const direction = this.getAlignmentDirection(content);

      this.positionCarat(
        trigger,
        toggleToolTipDimensions,
        carat,
        direction,
        marginFromTrigger,
      );
      ...
      if (direction === "top") {
        ...
        if (this.doesElementOverlapAnySide(content)) {
          this.checkAlternativesForTopPosition(
            trigger,
            toggleToolTipDimensions,
            content,
            carat,
        ...
        if (this.doesElementOverlapAnySide(content)) {
          this.checkAlternativesForBottomPosition(
            trigger,
            toggleToolTipDimensions,
            content,
            carat,
        ...
        if (this.doesElementOverlapAnySide(content)) {
          this.checkAlternativesForLeftPosition(
            trigger,
            toggleToolTipDimensions,
            content,
            carat,
        ...
        if (this.doesElementOverlapAnySide(content)) {
          this.checkAlternativesForRightPosition(
            trigger,
            toggleToolTipDimensions,
            content,
            carat,
    ...
    checkAlternativesForTopPosition: function (
      trigger,
      toggleToolTipDimensions,
      content,
      carat,
    ...
    checkAlternativesForBottomPosition: function (
      trigger,
      toggleToolTipDimensions,
      content,
      carat,
    ...
    checkAlternativesForLeftPosition: function (
      trigger,
      toggleToolTipDimensions,
      content,
      carat,
    ...
    checkAlternativesForRightPosition: function (
      trigger,
      toggleToolTipDimensions,
      content,
      carat,
