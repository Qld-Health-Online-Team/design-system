...
const meta = {
  ...
  argTypes: {
    ...
    toggleAll: {
      description:
        "Show an Open all / Close all toggle button above the accordion items.",
    ...
    title1: {
      description: "Title for accordion item 1.",
      control: { type: "text" },
    },
    content1: {
      description: "HTML content for accordion item 1.",
      control: { type: "text" },
    },
    title2: {
      description: "Title for accordion item 2.",
      control: { type: "text" },
    },
    content2: {
      description: "HTML content for accordion item 2.",
      control: { type: "text" },
    },
    title3: {
      description: "Title for accordion item 3.",
      control: { type: "text" },
    },
    content3: {
      description: "HTML content for accordion item 3.",
      control: { type: "text" },
    },
  },
  args: defaultArgs,
...
export const ToggleAllSync = {
  args: { toggleAll: true },
  play: async ({ canvasElement }) => {
    const toggleAllBtn = canvasElement.querySelector(
