...
export default {
  ...
  argTypes: {
    ...
    leadingText: {
      name: "leading_text",
      control: "text",
      description: "The text displayed leading the tags",
    },
    text: {
      control: "text",
      description: "The text to be displayed within the tag",
    },
    isLargeTag: {
      name: "is_large_tag",
      control: "boolean",
...
export const defaultVariantLarge = () =>
  Tags({ ...tagsArgs, type: "default", isLargeTag: true });
defaultVariantLarge.tags = ["!dev"];

export const actionVariant = () => Tags({ ...tagsArgs, type: "action" });
actionVariant.tags = ["!dev"];
export const actionVariantLarge = () =>
  Tags({ ...tagsArgs, type: "action", isLargeTag: true });
actionVariantLarge.tags = ["!dev"];

export const infoVariant = () => Tags({ ...tagsArgs, type: "info" });
infoVariant.tags = ["!dev"];
export const infoVariantLarge = () =>
  Tags({ ...tagsArgs, type: "info", isLargeTag: true });
