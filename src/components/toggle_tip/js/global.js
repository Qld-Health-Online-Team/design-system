(function () {
  ...
  toggleTip.init = function () {
    ...
    const toggleTipTriggers = document.querySelectorAll(
      toggleTipTriggerQueryClass,
    );
    ...
    toggleTipTriggers.forEach(function (toggleTipTrigger) {
      ...
      function openToggleTip() {
        ...
        QLD.toggleToolTips.openToggleToolTip(
          componentName,
          toggleTip,
          toggleTipTrigger,
          marginFromTrigger,
      ...
      function closeToggleTip() {
        QLD.toggleToolTips.closeToggleToolTip(
          componentName,
          toggleTip,
          toggleTipTrigger,
        );
    ...
    document.addEventListener("keydown", function (e) {
      if (e.key === "Escape" && lastTriggeredToggleTip) {
        const content = lastTriggeredToggleTip.querySelector(
