...
-   <a href={figmaLinks.tags.design} target="_blank" rel="noopener noreferrer">
        Component design view (Figma)
    </a>
-   <a href={figmaLinks.tags.file} target="_blank" rel="noopener noreferrer">
        Component file (Figma)
    </a>
-   <a href={figmaLinks.tags.ds} target="_blank" rel="noopener noreferrer">
