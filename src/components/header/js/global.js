...
(function () {
    ...
    function updateImageSource() {
        ...
        if (window.innerWidth <= 991) {
            imageElement.src = `./?a=${asset_metadata_siteLogoSecondaryMobile_value}`;
        } else {
            imageElement.src = `./?a=${asset_metadata_siteLogoSecondary_value}`;
        }
    }
    ...
    function toggleHeaderSearch() {
        ...
        if (isExpanded === "false") {
            ...
            setTimeout(function () {
                ...
                headerSearchEvents.background = addEvent(
                    document,
                    "click",
                    function () {
            ...
            // Add focus listeners
            headerSearchEvents.focusTop = addEvent(
                focustrapTop,
                "focus",
                function () {
            ...
            headerSearchEvents.menu = addEvent(
                menuToggle,
                "click",
                function () {
                    toggleHeaderSearch();
            ...
            // Add key listener
            headerSearchEvents.escKey = addEvent(
                document,
                "keyup",
                function () {
                    var event = event || window.event;
            ...
            searchToggle.classList.remove(
                "qld__main-nav__toggle-search--close"
            );
