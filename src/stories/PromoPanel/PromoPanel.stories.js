...
const renderPromoPanel = ({
  ...
  const imgElement =
    type === "qld__body--full-image"
      ? container.querySelector(".qld__promo-panel__container")
      : container.querySelector(".qld__promo-panel__image");
...
export default {
  ...
  argTypes: {
    ...
    abstract: {
      description: "The abstract of the component.",
      control: "text",
    },
    body: { description: "The body text.", control: "text" },
    promoImage: {
      description: "The image on this component.",
      control: "text",
    },
    bodyBackground: {
    ...
    secondaryLinkTitle: {
      description: "Secondary button title.",
      control: "text",
    },
