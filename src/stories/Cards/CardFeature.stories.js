...
const meta = {
  ...
  argTypes: {
    ...
    cardTitleUrl: {
      description: "URL the heading links to.",
      control: { type: "text" },
    },
    bodyText: {
    ...
    showArrow: {
      description: "Show directional arrow on the card.",
    ...
    introHeading: {
      description: "Optional section heading above the card.",
      control: { type: "text" },
    },
    introBody: {
      description: "Optional section intro body text.",
      control: { type: "text" },
    },
  },
  args: {
