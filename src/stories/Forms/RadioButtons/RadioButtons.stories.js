...
export default {
  ...
  argTypes: {
    ...
    legend: {
      control: "text",
      description: "The legend of the radio button group",
    },
    hintText: {
      control: "text",
      description: "The hint text of the radio button group",
    },
    isRequired: {
      control: "boolean",
      description: "If the component requires a response",
    },
    inError: {
      control: "boolean",
      description: "If the entire component is in an error state",
      if: { arg: "inSuccess", eq: false },
    },
    errorMessage: {
      control: "text",
      description: "The error message to be displayed if component is in error",
    },
    inSuccess: {
      control: "boolean",
      description: "If the entire component is in a success state",
      if: { arg: "inError", eq: false },
    },
    successMessage: {
      control: "text",
      description:
        "The success message to be displayed if component is in success",
    },
    inputs: {
      control: "array",
    ...
    isSmall: {
      control: "boolean",
      description: "If the radio buttons should use it's smaller variant",
    },
  },
